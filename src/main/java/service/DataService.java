  ...
  public static void createTeble() {
    ...
    String tContactsGroups =
        "create table if not exists main.contacts_groups("
            ...
            + "contact_id integer not null constraint contact_id__fk references contacts on delete cascade,"
            + "group_id integer not null constraint group_id__fk references groups on delete cascade);";
    ...
    String tContactsPhones =
        "create table if not exists main.contacts_phones ("
            ...
            + "contact_id integer not null constraint p_contacts_id__fk references contacts on delete cascade,"
            + "phone_id integer not null constraint c_phones___fk references phones on delete cascade);";
